                                        ...
                                        <div class="form-group row">
                                            <section class="col">
                                                ...
                                                <select name="selectedService" id="selectedService"
                                                    ...
                                                    <option value="{{ $item->service->id }}" @if($item->service->id == $selectedService)
...
eee
    ...
    <script>
        ...
        function restartObjects()
        {
            ...
            jQuery("#selectedLocation").on("select2:select", function (e) { @this.selectedLocation = jQuery('#selectedLocation').find(':selected').val(); });

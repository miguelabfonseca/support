...
:homePanel="$homePanel" :servicesPanel="$servicesPanel" :profile="$profile" :start_date="$start_date" :end_date="$end_date" :type="$type" buttonAction="{{ __('Create') }}" formTitle="{{ __('Create Task') }}" />

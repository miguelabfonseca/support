                        ...
                        <div class="card">
                            ...
                            <div class="card-body pb-0 dz-scroll height630 loadmore-content" id="latestSalesContent">
                                <div class="pb-3 mb-3 border-bottom">
                                    <p class="font-w600"><a href="{!! url('/event') !!}" class="text-black">The
                                            Story’s of Danau Toba (Drama Theater)</a></p>
                                    <div class="d-flex align-items-end">
                                        <img src="images/profile/20.jpg" alt="" width="42"
                                            class="rounded-circle mr-2">
                                        <div class="mr-auto">
                                            <h4 class="fs-14 mb-0"><a href="{!! url('/app-profile') !!}"
                                ...
                                <div class="pb-3 mb-3 border-bottom">
                                    <p class="font-w600"><a href="{!! url('/event') !!}" class="text-black">Envato
                                            Author SF Meetup</a></p>
                                    <div class="d-flex align-items-end">
                                        <img src="images/profile/21.jpg" alt="" width="42"
                                            class="rounded-circle mr-2">
                                        <div class="mr-auto">
                                            <h4 class="fs-14 mb-0"><a href="app-profile.com" class="text-black">Jacob
                                                    Swing Swing</a></h4>
                                ...
                                <div class="pb-3 mb-3 border-bottom">
                                    <p class="font-w600"><a href="{!! url('/event') !!}"
                                            class="text-black">Indonesia Envato Authors National Meetup</a></p>
                                    <div class="d-flex align-items-end">
                            ...
                            <div class="card-footer text-center border-0">
                                <a class="btn btn-primary btn-sm dz-load-more" id="latestSales"
                                    href="javascript:void(0)" rel="latest-sales">View More</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="event-bx owl-carousel">
                                    <div class="items">
                                        <div class="image-bx">
                                            ...
                                            <div class="info">
                                                <p class="fs-18 font-w600"><a href="{!! url('/event-detail') !!}"

        ...
        <div class="default-tab">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="home" role="tabpanel">
                    <div class="pt-4">
                        <x-tenant.customers.form :action="route('tenant.customers.store')" :update="false" buttonAction="Create" formTitle="{{ __('Create Customer') }}" :districts="$districts" :counties="$counties" :district="$district" :county="$county"/>
                    </div>
                </div>
